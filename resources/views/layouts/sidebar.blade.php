<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
            ...
            <div id="kt_app_sidebar_menu_scroll" class="hover-scroll-y my-5 mx-3" data-kt-scroll="true"
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold" id="#kt_app_sidebar_menu"
                    ...
                    <div class="menu-item">
                        ...
                        @else
                            ...
                            <a class="menu-link {{ request()->routeIs('user.index') ? 'active' : '' }}"
                                ...
                                <span class="menu-icon">
                                    <i class="ki-duotone ki-emoji-happy fs-2">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                                        <span class="path3"></span>
                                        <span class="path4"></span>
                    ...
                    <div class="menu-item">
                        @if (auth()->user()->role == 'admin')
                            <!--begin:Menu link-->
                            <a class="menu-link {{ request()->routeIs('mahasiswa*') ? 'active' : '' }}"
                            ...
                            <!--end:Menu link-->
                            <!--begin:Menu link-->
                            <a class="menu-link {{ request()->routeIs('kegiatan*') ? 'active' : '' }}"
    ...
    <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
        <a href="javascript:void(0);"
            ...
            data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="Hubungi Customer Service">
